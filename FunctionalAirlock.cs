...
{
	public class FunctionalAirlock : StateMachineComponent<FunctionalAirlock.SMInstance>
	{
		[SerializeField]
...
#pragma warning restore 649
		...
		{
			Debug.Log("whoa im running now");
			base.OnSpawn();
			smi.StartSM();
		}

		public class SMInstance : GameStateMachine<States, SMInstance, FunctionalAirlock, object>.GameInstance
		{
			private readonly Operational _operational;
			private readonly ElementConverter _converter;

			public SMInstance(FunctionalAirlock master) : base(master)
			{
		...
		public class States : GameStateMachine<States, SMInstance, FunctionalAirlock>
		{
